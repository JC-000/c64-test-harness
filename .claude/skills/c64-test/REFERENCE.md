...
- `vice_ethernet_interface` (default "") -- host network interface (e.g. "tap-c64")
- `vice_ethernet_driver` (default "") -- "tuntap" or "pcap"
...
ViceConfig(
    ...
    ethernet_interface="",  # Host interface (e.g. "tap-c64-a")
    ethernet_driver="",     # "tuntap" or "pcap" (empty = VICE default)
