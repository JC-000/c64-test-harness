#!/usr/bin/env python3
"""Run the live U64 test modules against a device you name.

Usage:
    python3 scripts/run_all_u64_live.py <HOST>
    U64_HOST=<device> python3 scripts/run_all_u64_live.py
...
def main() -> int:
    require_u64_host(
        ...
        argv0="python3 scripts/run_all_u64_live.py",
