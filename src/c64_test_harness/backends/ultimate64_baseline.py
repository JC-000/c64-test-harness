...
BASELINE_RECORDED_CATEGORY_SETS: dict[str, RecordedCategorySet] = {
    "ultimate": RecordedCategorySet(
        ...
        residuals=(
            ...
            "~/Documents/1541ultimate), not this record's 7f6fcb51.  In "
            "7f6fcb51..bce4535e no added or removed line under software/ or "
            ...
            "only effectuate_registered_settings), so the source derivation "
            "carries to the running build (source diff, read 2026-09-15).  The "
            "build flashed before #276 was not recorded either way, so the "
            "build candidate cannot be re-read.  Leaving out SID Detected "
            "Socket 1 and SID Detected Socket 2 -- the pair the entry "
            "baseline has exempted as detection-derived from ce4b0af "
            "(2026-09-05, before #276) -- gives #276's figure exactly, an "
            "arithmetic candidate that is inferred and not established.  "
            "The #276 script was not preserved, so the basis "
