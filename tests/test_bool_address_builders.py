...
BUILDERS = {
    ...
    "build_uci_command": (uci_network.build_uci_command, dict(target=4, cmd=1, params=b"", resp_addr=A.RESP, resp_len_addr=A.RLEN, **UCI), "790a77d085e1dbf0"),
    "build_get_ip": (uci_network.build_get_ip, dict(result_addr=A.RESP, resp_len_addr=A.RLEN, **UCI), "0521d1d685e37c3f"),
    "build_tcp_connect": (uci_network.build_tcp_connect, dict(host_addr=A.HOST, port=80, result_addr=A.RESP, resp_len_addr=A.RLEN, **UCI), "eb2c293b0542fc46"),
    "build_udp_connect": (uci_network.build_udp_connect, dict(host_addr=A.HOST, port=80, result_addr=A.RESP, resp_len_addr=A.RLEN, **UCI), "178d774424d55dac"),
    "build_socket_write": (uci_network.build_socket_write, dict(socket_id_addr=A.SOCK, data_addr=A.DATA, data_len_addr=A.DLEN, **UCI), "f7c762e4a864ef99"),
    "build_socket_read": (uci_network.build_socket_read, dict(socket_id_addr=A.SOCK, result_addr=A.RESP, max_len=100, actual_len_addr=A.ALEN, **UCI), "c21c42b497a4bba7"),
    "build_socket_close": (uci_network.build_socket_close, dict(socket_id_addr=A.SOCK, **UCI), "878f418f842eeb85"),
